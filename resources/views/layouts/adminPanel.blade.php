...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>SWIFTCART - @yield('page-title', 'Dashboard')</title>
    <script src="https://cdn.tailwindcss.com"></script>
            ...
            <div class="flex flex-col w-64 bg-white border-r border-gray-200">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto bg-white w-64 border-r border-gray-200">
                    <nav id="sidebarMenu" class="flex-1 space-y-2">
                        ...
                        <!-- Superadmin -->
                        {{-- <a href="#"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('#') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.brands.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.brands.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.products.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.products.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.shipping.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.shipping.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.orders.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.orders.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.reviews.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.reviews.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.discount.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.discount.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.users.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.users.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.pages.list') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.pages.list') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('admin.enquiries.index') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('admin.enquiries.index') ? 'bg-primary-700 text-white shadow-md hover:bg-primary-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                ...
                <div class="p-4 border-t border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm font-medium text-gray-700">DemoAdmin</p>
                            <p class="text-xs font-medium text-gray-500">DemoEmail</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <button id="userMenuButton" class="flex items-center space-x-2 focus:outline-none">
                            ...
                            <span class="text-sm font-medium text-gray-700">DemoNAme</span>
                        ...
                        <div id="userMenu"
                            ...
                            <div class="px-4 py-2 border-b border-gray-200">
                                ...
                                <p class="text-sm font-medium text-gray-700">DemoName</p>
                                <p class="text-xs text-gray-500">DemoEmail</p>
                            </div>
