    ...
    <div class="overflow-y-auto h-screen pb-10">
        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-semibold">Edit Staff</h2>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST" id="staffForm" name="staffForm"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    @if($staff->profile_picture)
                                        <img id="profilePreview" src="{{ asset('uploads/profile_pictures/thumb/' . $staff->profile_picture) }}" alt="Preview"
                                            class="mx-auto w-32 h-32 object-contain mb-2 rounded border border-gray-300" />
                                        <span id="profilePlaceholder" class="hidden">Drop files here or click to upload.</span>
                                    @else
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div
                                    class="form-control border-2 border-dashed border-blue-400 rounded p-6 text-center text-gray-500 cursor-pointer relative">
                                    @if($staff->id_proof)
                                        <img id="idProofPreview" src="{{ asset('uploads/id_proofs/thumb/' . $staff->id_proof) }}" alt="Preview"
                                            class="mx-auto w-32 h-32 object-contain mb-2 rounded border border-gray-300" />
                                        <span id="idProofPlaceholder" class="hidden">Drop files here or click to upload.</span>
                                    @else
                        ...
                        <div>
                            ...
                            <input type="text" id="id_number" name="id_number" value="{{ old('id_number', $staff->id_number) }}"
